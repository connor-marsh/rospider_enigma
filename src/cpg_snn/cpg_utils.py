...
class TimeSensitiveLeaky(snn.Leaky):
    def __init__(
        self,
        beta,
        threshold=1.0,
    ...
    def forward(self, input_, mem=None, time_since_update=1):
        ...
        self.mem = self.state_function(input_, time_since_update)
    ...
    def _base_state_function(self, input_, time_since_update=1):
        base_fn = (self.beta.clamp(0, 1) ** time_since_update) * self.mem + input_
        return base_fn

    def _base_sub(self, input_, time_since_update=1):
        return self._base_state_function(input_, time_since_update) - self.reset * self.threshold
